...
import uvicorn
from app.api.routers.activity import activity_router
from app.api.routers.unit import unit_router
from app.api.routers.slides import slides_router
...
app.include_router(unit_router, prefix="/api/units")
